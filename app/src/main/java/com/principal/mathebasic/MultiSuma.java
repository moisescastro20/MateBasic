...
public class MultiSuma extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_multi_suma);
        ...
        try {
            ...
            handler.postDelayed(new Runnable() {
                public void run() {
                    ...
                    etValor.setText("");
                    etValor.setTextColor(getResources().getColor(R.color.suma));
    ...
    public void dialogFinal(int numJugador, int puntos, int resultado) {
        ...
        if (resultado == 0) {
            ...
            if (user != "Invitado") {
                if (numJugador == 1) {
                    helper.insertMultiSuma(user, 1, 0, 0);
                } else if (numJugador == 2) {
                    helper.insertMultiSuma(user, 0, 0, 1);
                }
            }
        } else {
            titulo = "¡Empate!";
            ...
            if (user != "Invitado")
                helper.insertMultiSuma(user, 0, 1, 0);
        }
        // Configura el titulo.
