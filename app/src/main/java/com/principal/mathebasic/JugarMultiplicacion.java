...
public class JugarMultiplicacion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jugar_multiplicacion);
        ...
        builder
                ...
                .setPositiveButton("Aceptar",new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog,int id) {
                        ...
                        if(user!="Invitado")
                        helper.insertJugarMultip(user, puntos);
                        finish();
