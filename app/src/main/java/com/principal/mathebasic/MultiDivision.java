...
public class MultiDivision extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_multi_division);
    ...
    public void dialogFinal(int numJugador, int puntos, int resultado) {
        ...
        if (resultado == 0) {
            ...
            if (user != "Invitado") {
                if (numJugador == 1) {
                    helper.insertMultiPotencia(user, 1, 0, 0);
                } else if (numJugador == 2) {
                    helper.insertMultiPotencia(user, 0, 0, 1);
                }
            }
        } else {
            titulo = "¡Empate!";
            ...
            if (user != "Invitado")
                helper.insertMultiPotencia(user, 0, 1, 0);
        }
        // Configura el titulo.
