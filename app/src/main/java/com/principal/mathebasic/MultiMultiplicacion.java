...
public class MultiMultiplicacion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_multi_multiplicacion);
        ...
        try {
            ...
            handler.postDelayed(new Runnable() {
                public void run() {
                    ...
                    etValor.setText("");
                    etValor.setTextColor(getResources().getColor(R.color.multiplicacion));
    ...
    public void dialogFinal(int numJugador, int puntos, int resultado) {
        ...
        if (resultado == 0) {
            ...
            if (user != "Invitado") {
                if (numJugador == 1) {
                    helper.insertMultiMultip(user, 1, 0, 0);
                } else if (numJugador == 2) {
                    helper.insertMultiMultip(user, 0, 0, 1);
                }
            }
        } else {
            titulo = "¡Empate!";
            ...
            if (user != "Invitado")
                helper.insertMultiMultip(user, 0, 1, 0);
        }
        // Configura el titulo.
